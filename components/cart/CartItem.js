...
export default function CartItem({ 
  ...
  const hasDiscount = item.promoPrice && parseFloat(item.promoPrice) < parseFloat(item.price);
    ...
    <div className={`cart-item ${isUnavailable ? 'cart-item--unavailable' : 'available'}`}>
      ...
      <div className="cart-item__info">
        ...
        <div className="cart-item__meta">
          <button className="cart-item__favorite" onClick={() => onFavorite?.(item.id)}>
          ...
          <button className="cart-item__delete" onClick={() => onDelete?.(item.id)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {!isUnavailable && (
        <>
          <div className="cart-item__qty">
            <button className="qty-btn qty-btn--minus" onClick={handleMinus}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="qty-btn qty-btn--plus" onClick={handlePlus}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="cart-item__price no_promokod">
            {hasDiscount && (
              <>
                <span className="price-promo">
                  {item.promoPrice}<span className="price-currency">.{item.promoPriceCents || '00'} р.</span>
                </span>
                <span className="price-main">
                  {item.price}<span className="price-currency">.{item.priceCents || '00'} р.</span>
                </span>
                <span className="promo-size">
                  Скидка <span className="promo-size__calc">{item.discount}</span>р.
                </span>
            ...
            {!hasDiscount && (
              <span className="price-main">
                {item.price}<span className="price-currency">.{item.priceCents || '93'} р.</span>
              </span>
            )}
          </div>
        </>
