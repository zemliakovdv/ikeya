                            ...
                            <section className="checkout-section">
                              ...
                              {!hasPassport ? (
                                <div className="alert alert-warning">
                                  ...
                                  <span>Необходимо добавить <strong style={{ cursor: 'pointer', textDecoration: 'underline' }} onClick={() => setShowPassportModal(true)}>паспортные данные</strong> в профиле.</span>
                                </div>
                              ) : (
                                <>
