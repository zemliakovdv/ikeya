...
export default function CheckoutFilledPage() {
                      ...
                      <div className="cart-main">
                        <div className="checkout-container">
                          ...
                          <section className="checkout-section pickup-section">
                            <div className="section-header">
                              <div className="pickup-header-left">
                                <div className="pickup-icon">
                                  <img src="/assets/img/cart/autolight.png" alt="autolight" />
                                </div>
                                <div className="pickup-info">
                                  <h2 className="section-title">Автолайт</h2>
                                  <p className="pickup-address">ул. Дмитрия Донского, 11/1</p>
                                </div>
                              </div>
                              <button 
                            ...
                            {/* Дата получения и срок хранения */}
                          ...
                          {/* Способ оплаты - тот же код что и раньше */}
                          ...
                          <section className="checkout-section passport-section">
                            ...
                            <div className="passport-data">
                              ...
                              <div className="data-row">
                                ...
                                <span className="data-value">{showPassportData ? 'Христорождественский Иннокентий Адольфович' : 'Chris******* Inn*******'}</span>
                              </div>
                              ...
                              <div className="data-row data-row-split">
                                ...
                                <div className="data-column">
                                  ...
                                  <span className="data-value">{showPassportData ? '5623456' : '562****'}</span>
                                </div>
                              </div>
                              ...
                              <div className="data-row data-row-split">
                                <div className="data-column">
                                  ...
                                  <span className="data-value">{showPassportData ? '08.12.2015' : '08.**,****'}</span>
                                </div>
                                <div className="data-column">
                                  <span className="data-label">Кем выдан</span>
                                  <span className="data-value">{showPassportData ? 'Минским РУВД' : 'Минс**********'}</span>
                                </div>
                              </div>
                              ...
                              <div className="data-row data-row-split">
                                <div className="data-column">
                                  ...
                                  <span className="data-value">{showPassportData ? '4220612A045PB3' : '42206*********'}</span>
                                </div>
                                <div className="data-column">
                                  <span className="data-label">Дата рождения</span>
                                  <span className="data-value">{showPassportData ? '08.06.1992' : '08.**,****'}</span>
                                </div>
                              </div>
