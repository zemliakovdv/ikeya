                        ...
                        <div className="row g-4 swiper-slide-inner">
                            ...
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div style={{ '--swiper-navigation-color': '#fff', '--swiper-pagination-color': '#fff' }}
                                  className="swiper product-gallery-main" data-gallery="beds-1">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-1.png" alt="Товар" />
                                    </div>
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-2.png" alt="Товар" />
                                    </div>
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-3.png" alt="Товар" />
                                    </div>
                                  </div>
                                ...
                                <div data-thumbs-slider="" className="swiper product-gallery-thumbs" data-gallery-thumbs="beds-1">
                                  <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-3.png" alt="Миниатюра" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="product-card__info">
                                <h3 className="product-card__title">STOCKHOLM 2025</h3>
                                <p className="product-card__description">Стул, дуб/ротанг</p>
                              ...
                              <span className="sales-hit green">Новинка</span>
                          ...
                          <div className="col product-card-inner">
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div style={{ '--swiper-navigation-color': '#fff', '--swiper-pagination-color': '#fff' }}
                                  className="swiper product-gallery-main" data-gallery="beds-2">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-2.png" alt="Товар" />
                                    </div>
                              ...
                              <div className="product-card__info">
                                <h3 className="product-card__title">SONHULT</h3>
                                <p className="product-card__description">Stoliki, 2 szt.</p>
                                <p className="product-card__price">135<span>.00 р.</span></p>
                                <button className="shop_button">
                                  <img src="assets/img/icons/shopping-cart.svg" alt="В корзину" />
                                  <p>В корзину</p>
                          ...
                          <div className="col product-card-inner">
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div className="swiper product-gallery-main" data-gallery="beds-3">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-3.png" alt="Товар" />
                                    </div>
                                ...
                                <div className="swiper product-gallery-thumbs" data-gallery-thumbs="beds-3">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-3.png" alt="Миниатюра" />
                                    </div>
                              ...
                              <div className="product-card__info">
                                <h3 className="product-card__title">STOCKHOLM 2025</h3>
                                <p className="product-card__description">Стул, дуб/кожа</p>
                                <p className="product-card__price">135<span>.00 р.</span></p>
                                <button className="shop_button">
                                  <img src="assets/img/icons/shopping-cart.svg" alt="В корзину" />
                                  <p>В корзину</p>
                          ...
                          <div className="col product-card-inner">
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div className="swiper product-gallery-main" data-gallery="beds-4">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-4.png" alt="Товар" />
                                    </div>
                                  </div>
                                </div>
                                <div className="swiper product-gallery-thumbs" data-gallery-thumbs="beds-4">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-4.png" alt="Миниатюра" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="product-card__info">
                                <h3 className="product-card__title">STOCKHOLM 2025</h3>
                                <p className="product-card__description">Журнальный столик</p>
                                <p className="product-card__price">135<span>.00 р.</span></p>
                                <button className="shop_button">
                                  <img src="assets/img/icons/shopping-cart.svg" alt="В корзину" />
                                  <p>В корзину</p>
                          ...
                          <div className="col product-card-inner">
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div className="swiper product-gallery-main" data-gallery="beds-5">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-5.png" alt="Товар" />
                                    </div>
                                  </div>
                                </div>
                                <div className="swiper product-gallery-thumbs" data-gallery-thumbs="beds-5">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-5.png" alt="Миниатюра" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="product-card__info">
                                <h3 className="product-card__title">ARKELSTORP</h3>
                                <p className="product-card__description">Журнальный столик</p>
                                <p className="product-card__price">135<span>.00 р.</span></p>
                                <button className="shop_button">
                                  <img src="assets/img/icons/shopping-cart.svg" alt="В корзину" />
                      ...
                      <div className="swiper-slide">
                        <div className="row g-4 swiper-slide-inner">
                          <div className="col product-card-inner">
                            <div className="product-card">
                              <div className="product-card__gallery">
                                <div className="swiper product-gallery-main" data-gallery="beds-6">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-1.png" alt="Товар" />
                                    </div>
                                ...
                                <div className="swiper product-gallery-thumbs" data-gallery-thumbs="beds-6">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img src="assets/img/main-page/news/new-1.png" alt="Миниатюра" />
                                    </div>
