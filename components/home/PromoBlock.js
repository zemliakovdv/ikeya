                    ...
                    <div className="swiper-wrapper">
                        ...
                        <div className="promo-card-item">
                          <div className="product-card">
                            ...
                            <div className="promo-card__gallery">
                              <img src="/assets/img/main-page/promo-block/promo-card-1.png" alt="Товар" />
                            </div>
                      ...
                      <div className="swiper-slide">
                        <div className="promo-card-item">
                          <div className="product-card">
                            <div className="promo-card__gallery">
                              <img src="/assets/img/main-page/promo-block/promo-card-2.png" alt="Товар" />
                            </div>
                      ...
                      <div className="swiper-slide">
                        <div className="promo-card-item">
                          <div className="product-card">
                            <div className="promo-card__gallery">
                              <img src="/assets/img/main-page/promo-block/promo-card-3.png" alt="Товар" />
                            </div>
