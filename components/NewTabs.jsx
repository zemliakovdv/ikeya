                                            ...
                                            <div className="swiper-slide">
                                                <div className="row g-4 swiper-slide-inner">
                                                    <ProductCard
                                                        ...
                                                        thumbs={[
                                                            { src: "assets/img/main-page/news/new-1.png" },
                                                            { src: "assets/img/main-page/news/new-2.png" },
                                                            { src: "assets/img/main-page/news/new-3.png" },
                                                            { isMore: true, count: "+2" }
                                                        ]}
                                                    ...
                                                    <ProductCard
                                                        ...
                                                        thumbs={[
                                                            { src: "assets/img/main-page/news/new-2.png" },
                                                            { src: "assets/img/main-page/news/new-3.png" },
                                                            { src: "assets/img/main-page/news/new-4.png" }
                                                        ]}
                                                        title="SONHULT"
                                                    ...
                                                    <ProductCard
                                                        ...
                                                        thumbs={[{ src: "assets/img/main-page/news/new-3.png" }]}
                                                        title="STOCKHOLM 2025"
                                                    ...
                                                    <ProductCard
                                                        ...
                                                        thumbs={[{ src: "assets/img/main-page/news/new-4.png" }]}
                                                        title="STOCKHOLM 2025"
                                                    ...
                                                    <ProductCard
                                                        ...
                                                        thumbs={[{ src: "assets/img/main-page/news/new-5.png" }]}
                                                        title="ARKELSTORP"
                                            ...
                                            <div className="swiper-slide">
                                                <div className="row g-4 swiper-slide-inner">
                                                    <ProductCard
                                                        ...
                                                        thumbs={[{ src: "assets/img/main-page/news/new-1.png" }]}
                                                        title="SLATTUM"
                                                        description="Каркас кровати с обивкой, Vissle темно-серый, 140x200 см"
                                                        price="135"
                                                        salesHit={true}
                                                    ...
                                                    <ProductCard
                                                        galleryId="sofas-2"
                                                        images={["assets/img/main-page/news/new-2.png"]}
                                                        thumbs={[{ src: "assets/img/main-page/news/new-2.png" }]}
                                                        title="SLATTUM"
                                                        description="Каркас кровати с обивкой, Vissle темно-серый, 140x200 см"
                                                        price="135"
                                                        salesHit={true}
