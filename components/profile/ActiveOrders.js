          ...
          <div className="order-status-content">
            <div className="order-status-inner">
              ...
              <div className="status-text">
                ...
                {countdown && <> <strong className="timer-value">{countdown}.</strong></>} <span>Скопируйте код заказа для удобства оплаты. Автоматическая отмена заказа происходит сразу после истечения срока оплаты.</span>
              </div>
            </div>
