    ...
    <>
      ...
      <div className="summary">
        ...
        >
          ...
          <div className="summary-sub">135 товаров</div>
        </div>
        ...
        <div className="summary-card">
          ...
          <div className="summary-sub">5 товаров</div>
        </div>
      </div>
      ...
      <div className="block">
        ...
        <div className="orders">
          <div 
            ...
            onClick={() => router.push('/profile/order-waiting-payment')}
            style={{ cursor: 'pointer' }}
          >
            ...
            <div className="order-info">
              <div className="order-title">Заказ №6651 от 29 июня</div>
              <span className="status red">Ждет оплаты</span>
            </div>
          </div>

          <div 
            className="order-card"
            onClick={() => router.push('/profile/order-in-transit')}
            style={{ cursor: 'pointer' }}
          >
            <div className="order-image">
              <Image 
                src="/assets/img/profile/active_2.png" 
                alt="Заказ" 
                width={56}
                height={56}
              />
            ...
            <div className="order-info">
              <div className="order-title">Заказ №6651 от 29 июня</div>
              <span className="status gray">Подготовка и сборка заказа</span>
            </div>
          </div>

          <div 
            className="order-card"
            onClick={() => router.push('/profile/order-arrived')}
            style={{ cursor: 'pointer' }}
          >
            <div className="order-image">
              <Image 
                src="/assets/img/profile/active_3.png" 
                alt="Заказ" 
                width={56}
                height={56}
              />
            ...
            <div className="order-info">
              <div className="order-title">Заказ №6651 от 29 июня</div>
              <span className="status greeen">Прибыл в ПВЗ</span>
            </div>
          </div>
        </div>
      </div>
