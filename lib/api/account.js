...
const ACTIVE_STATUSES = [
  'created', 'awaiting_payment', 'pending', 'processing', 'paid',
  'assembly', 'assembly_process', 'transit', 'handed_to_courier',
  'customs_poland', 'customs_belarus', 'available_warehouse',
  'delivering', 'delivered_to_pvz',
];
