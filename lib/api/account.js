...
const WHERE_IS_ORDER_HIDDEN_STATUSES = ['created', 'processing'];
...
export function canShowWhereIsOrderButton(order) {
  ...
  if (WHERE_IS_ORDER_HIDDEN_STATUSES.includes(rawStatus)) return false;
